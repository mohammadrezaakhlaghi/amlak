                ...
                <div class="site-main">
                    ...
                    <div class="shop-top-control">
                        <form class="select-item select-form">
                            <span class="title">ترتیب بر اساس</span>
                            <select title="sort" data-placeholder="9 Products/Page" class="chosen-select">
                                <option value="2">9 آگهی/صفحه</option>
                                <option value="1">12 آگهی/صفحه</option>
                                <option value="3">10 آگهی/صفحه</option>
                                <option value="4">8 آگهی/صفحه</option>
                                <option value="5">6 آگهی/صفحه</option>
                            </select>
                        </form>
                        <form class="filter-choice select-form">
                            <span class="title">ترتیب بر اساس</span>
                            <select title="sort-by" data-placeholder="Price: Low to High" class="chosen-select">
                                <option value="1">قیمت: کمتر به بیشتر</option>
                                ...
                                <div class="product-thumb">
                                    <div class="thumb-inner">
                                        <a href="{{route('detail', ['id'=>$item->id, 'type'=>$item->type])}}">
                                            <img src="/uploads/{{$item->id . ".jpg"}}" alt="img">
                                        </a>
                ...
                <div class="wrapper-sidebar shop-sidebar">
                    <div class="widget woof_Widget">
                        <div class="widget widget-categories">
                            <h3 class="widgettitle">دسته بندی</h3>
